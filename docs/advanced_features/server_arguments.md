...
| Argument | Description | Defaults | Options |
| --- | --- | --- | --- |
| `--speculative-algorithm` | Speculative algorithm. | `None` | `EAGLE`, `EAGLE3`, `NEXTN`, `STANDALONE`, `PEARL`, `NGRAM` |
...
| `--speculative-draft-gpu-id` | The GPU id to place the draft model for speculative decoding. | `None` | Type: int |
